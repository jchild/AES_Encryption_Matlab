function output = galois3table()
%   galois3table	builds the table for galois multiplication by 3
%
%   Syntax:
%       output = galois3table()
%
%   Output:
%       output = the resulting galois table for multiplication by 3
%

% The lookup table.
lookup_table = [    '00','03','06','05','0c','0f','0a','09','18','1b','1e','1d','14','17','12','11';
